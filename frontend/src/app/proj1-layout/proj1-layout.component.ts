...
@Component({
  selector: 'app-proj1-layout',
  templateUrl: './proj1-layout.component.html',
  styleUrls: ['./proj1-layout.component.css']
})
export class Proj1LayoutComponent implements OnInit {
  ...
  private updateCurrentViewFromRoute(url: string): void {
    ...
    if (segments.length >= 3 && segments[1] === 'proj1') {
  ...
  setCurrentView(view: string): void {
    ...
    this.router.navigate(['/proj1', route]);
  }
